...
class ConnectivityThresholds(BaseModel):
    ...
    min_project_coverage: float = 0.85  # 85% of projects should connect to AF and measures
...
class AnalyzerConfig(BaseModel):
    ...
    integrity_thresholds: IntegrityThresholds = Field(default_factory=IntegrityThresholds)
    connectivity_thresholds: ConnectivityThresholds = Field(default_factory=ConnectivityThresholds)
