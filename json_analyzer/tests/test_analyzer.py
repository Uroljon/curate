        ...
        "action_fields": [
            {
                "id": "af_1",
                "content": {
                    "title": "Test Action Field",
                    "name": "Test Action Field"
                },
                "connections": [
                    {
                        "target_id": "proj_1",
...
def test_quality_score_calculation():
    ...
    expected_categories = ["integrity", "connectivity", "confidence", "sources", "content"]
...
def test_compare_files():
    ...
    try:
        ...
        assert result.before.graph_stats.total_nodes < result.after.graph_stats.total_nodes
