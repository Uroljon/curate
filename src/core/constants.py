...
ADVANCED_MEASURE_PATTERNS = {
    "initiative_verbs": [
        "initiieren", "anstoßen", "etablieren", "implementieren", 
        "realisieren", "umsetzen", "durchführen", "entwickeln",
        "einrichten", "schaffen", "aufbauen", "errichten",
        "bereitstellen", "gewährleisten", "sicherstellen", "ermöglichen"
    ],
    "administrative_actions": [
        "bereitstellung von", "gewährleistung von", "sicherstellung von", 
        "ermöglichung von", "schaffung von", "einrichtung von", 
        "aufbau von", "errichtung von", "durchführung von",
        "realisierung von", "umsetzung von", "implementierung von"
    ],
    "planning_instruments": [
        "konzept entwickeln", "strategie erarbeiten", "leitfaden erstellen",
        "rahmen schaffen", "grundlage legen", "masterplan erstellen",
        "handlungskonzept", "aktionsplan", "arbeitsgruppe bilden"
    ]
}
...
ADVANCED_INDICATOR_PATTERNS = {
    ...
    "measurement_verbs": [
        "erreichen", "reduzieren", "steigern", "erhöhen", "senken",
        "verbessern um", "verringern um", "zunehmen um", "ansteigen auf",
        "sinken auf", "verdoppeln", "halbieren", "vervielfachen"
    ],
    "success_metrics": [
        "zielwert", "kennzahl", "indikator", "messgröße",
        "erfolgsparameter", "leistungskennzahl", "benchmark",
        "richtwert", "sollwert", "grenzwert"
    ]
}
...
CONFIDENCE_BOOSTERS = {
    "very_high": [
        "eindeutig", "klar definiert", "messbar", "quantifiziert",
        "konkret", "spezifisch", "explizit", "präzise"
    ],
    "high": [
        "typischerweise", "in der regel", "üblicherweise", 
        "gewöhnlich", "standardmäßig", "regulär"
    ],
    "medium": [
        "wahrscheinlich", "vermutlich", "tendenziell",
        "voraussichtlich", "mutmaßlich", "möglicherweise"
    ],
    "low": [
        "eventuell", "unter umständen", "gegebenenfalls",
        "potentiell", "denkbar", "fraglich"
    ]
}
...
ADMINISTRATIVE_LANGUAGE_PATTERNS = {
    ...
    "decision_language": [
        "beschlossen", "festgelegt", "bestimmt", "angeordnet",
        "verfügt", "entschieden", "beschließen", "festlegen"
    ],
    "implementation_language": [
        "zur umsetzung", "zur realisierung", "zur durchführung",
        "zur implementierung", "zur einführung", "zur etablierung"
    ]
}
...
ENHANCED_ACTION_FIELD_PATTERNS = {
    "standard_fields": {
        "mobilität": ["verkehr", "mobilität", "öpnv", "radweg", "fußgänger", "elektromobilität"],
        "klimaschutz": ["klima", "energie", "emission", "erneuerbar", "co2", "nachhaltigkeit"],
        "stadtentwicklung": ["stadtplanung", "quartier", "wohnen", "bauland", "städtebau"],
        "digitalisierung": ["digital", "smart city", "e-government", "online", "vernetzung"],
        "bildung": ["schule", "bildung", "kita", "kindergarten", "ausbildung", "weiterbildung"],
        "gesundheit": ["gesundheit", "medizin", "pflege", "prävention", "therapie"],
        "kultur": ["kultur", "kunst", "museum", "theater", "bibliothek", "veranstaltung"],
...
TEXT_QUALITY_INDICATORS = {
    ...
    "administrative_terms": [
        "stadtverwaltung", "gemeinderat", "bürgermeister", "amt für",
        "fachdienst", "stadtwerke", "öffentlicher träger", "kommunal"
    ],
    "document_structure": [
        "inhaltsverzeichnis", "zusammenfassung", "executive summary",
        "zielsetzung", "ausgangssituation", "handlungsempfehlung"
    ]
}
