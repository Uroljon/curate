...
class ChunkQualityMonitor:
    ...
    def analyze_chunks(chunks: list[str], stage: str = "semantic") -> dict[str, Any]:
        ...
        metrics = {
            ...
            "structural_stats": {
                "chunks_with_paragraphs": sum(
                    1 for stat in structural_stats if stat["has_double_newline"]
                ),
                "chunks_with_page_markers": sum(
                    1 for stat in structural_stats if stat["has_page_marker"]
                ),
                "chunks_with_structure": sum(
                    1
