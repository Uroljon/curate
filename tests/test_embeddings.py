...
def test_embedding_model():
    ...
    try:
        ...
        test_pairs = [
            ...
            ("Klimaschutz ist wichtig", "Umweltschutz ist bedeutend", (0.7, 1.0), "Similar concepts"),
            ("CO2-Reduktion um 40%", "CO2-Emissionen senken", (0.6, 0.9), "Related climate terms"),
            ("Mobilität und Verkehr", "Transport und Verkehrswesen", (0.7, 1.0), "Same topic"),
            ("Klimaschutz", "Digitalisierung", (0.0, 0.3), "Different topics"),
            ("Stadtbahn Regensburg", "Straßenbahn in Regensburg", (0.7, 1.0), "Same project, different words"),
        ]
        ...
        for text1, text2, expected_range, description in test_pairs:
            ...
            print(f"   '{text1}' ↔ '{text2}'")
            print(f"   Similarity: {similarity:.3f} (expected: {expected_range[0]:.1f}-{expected_range[1]:.1f})")
        ...
        assert test_embedding.shape[1] == expected_dim, f"Expected {expected_dim} dimensions, got {test_embedding.shape[1]}"
