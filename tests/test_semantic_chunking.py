...
def compare_chunking_methods(source_id: str):
    ...
    print("\n📈 QUALITY COMPARISON:")
    print(
        f"  Mixed sections reduced by: {old_quality['mixed_sections'] - new_quality['mixed_sections']}"
    )
    print(
        f"  Heading preservation: {new_quality['chunks_with_headings']}/{new_quality['total_chunks']} "
