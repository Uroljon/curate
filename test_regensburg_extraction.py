...
def test_regensburg_extraction():
    ...
    print(f"  Chunk consolidation: {metadata.get('original_chunks', 'N/A')} → {metadata.get('llm_chunks', 'N/A')} LLM chunks")
    print()
    ...
    if chunk_quality:
        ...
        if topic_coherence:
            print(f"  Single topic chunks: {topic_coherence.get('chunks_with_single_topic', 'N/A')}")
            print(f"  Multiple topic chunks: {topic_coherence.get('chunks_with_multiple_topics', 'N/A')}")
            print(f"  No topic chunks: {topic_coherence.get('chunks_with_no_topic', 'N/A')}")
